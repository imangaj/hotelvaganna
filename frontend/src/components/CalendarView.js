...
const CalendarView = () => {
    ...
    const formatDateEU = (dateStr) => new Date(dateStr).toLocaleDateString("it-IT", { timeZone: "Europe/Rome" });
    const formatShortDateEU = (dateStr) => new Date(dateStr).toLocaleDateString("it-IT", { timeZone: "Europe/Rome", month: "short", day: "numeric" });
