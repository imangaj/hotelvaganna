...
export const buildReservationReceiptHtml = (options: ReceiptOptions) => {
  ...
  const hotel = {
    ...
    logoUrl: profile?.logoUrl || "/logo-192.png",
  };
  ...
  <html>
    ...
    <body>
      ...
      ${cityTaxPerPersonPerNight > 0 ? `
      <div class="section card">
        <div class="title">City Tax</div>
        <div class="row"><span>Notice</span><span>City tax is ${cityTaxPerPersonPerNight} euro per person per night</span></div>
      </div>
      ` : ""}
