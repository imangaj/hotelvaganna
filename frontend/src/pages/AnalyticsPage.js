...
const AnalyticsPage = () => {
    ...
    if (loading && properties.length === 0) {
        return _jsx("div", { className: "loading", children: "Loading analytics..." });
    }
    return (_jsxs("div", { className: "page-container", children: [_jsxs("div", { className: "page-header", children: [_jsx("h2", { children: "Analytics & Reports" }), _jsx("div", { className: "header-actions", children: properties.length > 0 && (_jsxs("select", { value: selectedProperty || "", onChange: (e) => setSelectedProperty(Number(e.target.value)), className: "property-select", children: [_jsx("option", { value: "", children: "Select Property" }), properties.map((property) => (_jsx("option", { value: property.id, children: property.name }, property.id)))] })) })] }), error && _jsx("div", { className: "error-message", children: error }), selectedProperty && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "date-range-filter", children: [_jsxs("div", { className: "filter-group", children: [_jsx("label", { htmlFor: "startDate", children: "From:" }), _jsx("input", { type: "date", id: "startDate", value: dateRange.startDate, onChange: (e) => setDateRange(prev => ({ ...prev, startDate: e.target.value })) })] }), _jsxs("div", { className: "filter-group", children: [_jsx("label", { htmlFor: "endDate", children: "To:" }), _jsx("input", { type: "date", id: "endDate", value: dateRange.endDate, onChange: (e) => setDateRange(prev => ({ ...prev, endDate: e.target.value })) })] })] }), _jsxs("div", { className: "metrics-grid", children: [_jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: "\uD83D\uDCB0" }), _jsxs("div", { className: "metric-content", children: [_jsx("h3", { children: "Total Revenue" }), _jsxs("p", { className: "metric-value", children: ["$", metrics.totalRevenue.toFixed(2)] }), _jsx("p", { className: "metric-label", children: "All bookings" })] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: "\uD83D\uDCC5" }), _jsxs("div", { className: "metric-content", children: [_jsx("h3", { children: "Confirmed Bookings" }), _jsx("p", { className: "metric-value", children: metrics.confirmedBookings }), _jsx("p", { className: "metric-label", children: "Active reservations" })] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: "\uD83C\uDFE0" }), _jsxs("div", { className: "metric-content", children: [_jsx("h3", { children: "Occupied Rooms" }), _jsx("p", { className: "metric-value", children: metrics.occupiedRooms }), _jsx("p", { className: "metric-label", children: "Currently checked in" })] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: "\u2705" }), _jsxs("div", { className: "metric-content", children: [_jsx("h3", { children: "Checked Out" }), _jsx("p", { className: "metric-value", children: metrics.checkedOutBookings }), _jsx("p", { className: "metric-label", children: "Completed stays" })] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: "\uD83D\uDCCA" }), _jsxs("div", { className: "metric-content", children: [_jsx("h3", { children: "Avg Booking Value" }), _jsxs("p", { className: "metric-value", children: ["$", metrics.avgBookingValue.toFixed(2)] }), _jsx("p", { className: "metric-label", children: "Per reservation" })] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: "\uD83D\uDCC8" }), _jsxs("div", { className: "metric-content", children: [_jsx("h3", { children: "Total Bookings" }), _jsx("p", { className: "metric-value", children: metrics.totalBookings }), _jsx("p", { className: "metric-label", children: "In period" })] })] })] }), _jsxs("div", { className: "reports-grid", children: [_jsxs("div", { className: "report-card", children: [_jsx("h3", { children: "Revenue by Source" }), _jsx("div", { className: "report-content", children: Object.entries(revenueBySource).map(([source, revenue]) => (_jsxs("div", { className: "report-row", children: [_jsx("span", { children: source }), _jsxs("span", { className: "report-value", children: ["$", revenue.toFixed(2)] })] }, source))) })] }), _jsxs("div", { className: "report-card", children: [_jsx("h3", { children: "Bookings by Status" }), _jsx("div", { className: "report-content", children: Object.entries(bookingsByStatus).map(([status, count]) => (_jsxs("div", { className: "report-row", children: [_jsx("span", { children: status }), _jsx("span", { className: "report-value", children: count })] }, status))) })] })] }), _jsxs("div", { className: "report-card full-width", children: [_jsx("h3", { children: "Recent Bookings" }), _jsx("div", { className: "table-container", children: _jsxs("table", { className: "bookings-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "ID" }), _jsx("th", { children: "Room" }), _jsx("th", { children: "Check In" }), _jsx("th", { children: "Check Out" }), _jsx("th", { children: "Total Price" }), _jsx("th", { children: "Status" }), _jsx("th", { children: "Source" })] }) }), _jsx("tbody", { children: bookings.slice(0, 10).map((booking) => (_jsxs("tr", { children: [_jsxs("td", { children: ["#", booking.id] }), _jsx("td", { children: booking.room?.roomNumber }), _jsx("td", { children: new Date(booking.checkInDate).toLocaleDateString() }), _jsx("td", { children: new Date(booking.checkOutDate).toLocaleDateString() }), _jsxs("td", { children: ["$", booking.totalPrice.toFixed(2)] }), _jsx("td", { children: _jsx("span", { className: `badge badge-${booking.bookingStatus === "CONFIRMED" ? "success" : "info"}`, children: booking.bookingStatus }) }), _jsx("td", { children: booking.source })] }, booking.id))) })] }) })] })] }))] }));
};
